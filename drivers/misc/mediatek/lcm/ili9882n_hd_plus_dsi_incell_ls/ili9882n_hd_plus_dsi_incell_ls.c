...
{0x0a,0x01,{0x73}},
{0x0b,0x01,{0x00}},
{0x0c,0x01,{0x36}},  //CLK duty modify for sensor mura by shawn_20200512_5A
{0x0d,0x01,{0x36}},  //CLK duty modify for sensor mura by shawn_20200512_5A   
{0x0e,0x01,{0x05}},
{0x0f,0x01,{0x05}},
{0x28,0x01,{0x49}},   //48
{0x29,0x01,{0x85}},   //86
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
	...
	pr_debug("[ls_ili9882n]para_list[0]=%x,para_list[1]=%x\n",bl_level[1].para_list[0],bl_level[1].para_list[1]);
...
struct LCM_DRIVER ili9882n_hd_plus_dsi_vdo_ls_lcm_drv = {
	.name = "ili9882n_hd_plus_vdo_ls",
#endif

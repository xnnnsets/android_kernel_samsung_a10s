...
{
//EXTB P200821-05585,zhaosidong.wt,ADD,20200909,switch off the Vbus while phone is power off
	struct bq2415x *bq = i2c_get_clientdata(client);
	if (bq->otg_online == true) {
		charger_dev_enable_otg(bq->chg_dev, false);
	}

	pr_info("charger driver over, shutdown\n");
}

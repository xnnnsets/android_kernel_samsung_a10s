...
UINT32 N21_HLT_SUB_HI1336_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 N21_CXT_DEPTH_GC02M1B_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);//bug 530174,gaoyu1.wt,add,20200113,bring up depth gc02m1b
...
UINT32 N21_LHYX_DEPTH_BF2253_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 N21_TXD_WIDE_HI846MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);

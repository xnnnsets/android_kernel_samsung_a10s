...
#define per_frame 1
extern bool read_n8_hi1336_txd_jct_eeprom( kal_uint16 addr, BYTE *data, kal_uint32 size); 
...
static struct imgsensor_info_struct imgsensor_info = { 
	.sensor_id = N8_HI1336_TXD_JCT_SENSOR_ID,
...
static kal_uint16 n8_hi1336_txd_jct_table_write_cmos_sensor(
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_init_n8_hi1336_txd_jct[] = {
	0x2000, 0x0021,
	0x2002, 0x04a5,
	0x2004, 0xb124,
	0x2006, 0xc09c,
...
static void sensor_init(void)
{
	...
	n8_hi1336_txd_jct_table_write_cmos_sensor(
		addr_data_pair_init_n8_hi1336_txd_jct,
		sizeof(addr_data_pair_init_n8_hi1336_txd_jct) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_preview_n8_hi1336_txd_jct[] = {
...
static void preview_setting(void)
{
	...
	n8_hi1336_txd_jct_table_write_cmos_sensor(
		addr_data_pair_preview_n8_hi1336_txd_jct,
		sizeof(addr_data_pair_preview_n8_hi1336_txd_jct) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_30fps_n8_hi1336_txd_jct[] = {
...
static kal_uint16 addr_data_pair_capture_15fps_n8_hi1336_txd_jct[] = {
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps > 150) {
	n8_hi1336_txd_jct_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_n8_hi1336_txd_jct,
		sizeof(addr_data_pair_capture_30fps_n8_hi1336_txd_jct) /
		sizeof(kal_uint16));

	} else {
	n8_hi1336_txd_jct_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_n8_hi1336_txd_jct,
		sizeof(addr_data_pair_capture_15fps_n8_hi1336_txd_jct) /
		sizeof(kal_uint16));
	}
#else
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_hs_video_n8_hi1336_txd_jct[] = {
	0x3250, 0xa470,
	0x0730, 0x770f,
	0x0732, 0xe4b0,
	0x1118, 0x0072,
...
#if MULTI_WRITE
	n8_hi1336_txd_jct_table_write_cmos_sensor(
		addr_data_pair_hs_video_n8_hi1336_txd_jct,
		sizeof(addr_data_pair_hs_video_n8_hi1336_txd_jct) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_slim_video_n8_hi1336_txd_jct[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe2b0,
	0x1118, 0x01a8,
...
static void slim_video_setting(void)
{
	...
	n8_hi1336_txd_jct_table_write_cmos_sensor(
		addr_data_pair_slim_video_n8_hi1336_txd_jct,
		sizeof(addr_data_pair_slim_video_n8_hi1336_txd_jct) /
		sizeof(kal_uint16));
#else
...
static struct stCAM_CAL_DATAINFO_STRUCT hi1336_txd_jct_eeprom_data ={
	.sensorID= N8_HI1336_TXD_JCT_SENSOR_ID,
	.deviceID = 0x01,
	.dataLength = 0x0CE9,
	.sensorVendorid = 0x19000102,
	.vendorByte = {1,2,3,4},
	.dataBuffer = NULL,
};
static struct stCAM_CAL_CHECKSUM_STRUCT hi1336txdChecksum[8] =
{
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		spin_unlock(&imgsensor_drv_lock);
		do {
                         printk("enter get_imgsensor_id\n");
			*sensor_id = return_sensor_id()+2;
			if (*sensor_id == imgsensor_info.sensor_id) {
				size = imgSensorReadEepromData(&hi1336_txd_jct_eeprom_data,hi1336txdChecksum);
				if(size != hi1336_txd_jct_eeprom_data.dataLength) {
					printk("get eeprom data failed\n");
					if(hi1336_txd_jct_eeprom_data.dataBuffer != NULL) {
						kfree(hi1336_txd_jct_eeprom_data.dataBuffer);
						hi1336_txd_jct_eeprom_data.dataBuffer = NULL;
					}
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					LOG_INF("get eeprom data success\n");
					imgSensorSetEepromData(&hi1336_txd_jct_eeprom_data);
				}

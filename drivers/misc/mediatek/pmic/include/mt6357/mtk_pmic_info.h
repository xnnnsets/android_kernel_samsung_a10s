...
extern unsigned int mt6357_upmu_set_rg_vs1_modeset(unsigned int);
//-OA 6869643,liyu.wt, add ,20201023, extern the function for being invoked of upmu_initial_setting.c

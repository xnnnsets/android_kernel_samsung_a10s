...
static void ili_update_tp_module_info(void)
{
	...
	case MODEL_LS:
		ilits->md_name = "LS";
		ilits->md_fw_filp_path = LS_FW_FILP_PATH;
		ilits->md_fw_rq_path = LS_FW_REQUEST_PATH;
		ilits->md_ini_path = LS_INI_NAME_PATH;
		ilits->md_ini_rq_path = LS_INI_REQUEST_PATH;
		ilits->md_fw_ili = CTPM_FW_LS;
		ilits->md_fw_ili_size = sizeof(CTPM_FW_LS);
		break;
	case MODEL_INX:
		ilits->md_name = "INX";
